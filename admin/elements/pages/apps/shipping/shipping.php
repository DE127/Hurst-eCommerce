                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                ...
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#kt_modal_add_payments">Add Shipping</button>
                                <!--end::Add customer-->
                            </div>
                            <!--end::Toolbar-->
                            <!--begin::Group actions-->
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <td>
                                        <p type="text" class="form-control mb-2" placeholder="Description" name="price" style="border: none;">' . $row['price'] . '</p>
									</td>
									<td>';
                                    if ($row['status'] == 0)
                                    ...
                                    echo '</td>
									<td class="text-end">
										<a href="?action=shipping&query=list&id=' . $row['id'] . '&delete" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Delete
										</a>
									</td>
                                    </tr>';
                                }
                        ...
                        <div class="modal-content">
                            ...
                            <form class="form" action="" id="kt_modal_add_customer_form" method="post">
                                ...
                                <div class="modal-header" id="kt_modal_add_customer_header">
                                    <!--begin::Modal title-->
                                    <h2 class="fw-bold">Add a Shipping Method</h2>
                                    <!--end::Modal title-->
                                    <!--begin::Close-->
