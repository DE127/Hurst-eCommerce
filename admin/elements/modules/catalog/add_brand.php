...
if (isset($_POST['btn-save'])) {
    ...
    if (!$error) {
        $query = "INSERT INTO brand(status, name, description) VALUES('$status', '$name', '$description')";
        ...
        if (!empty($thumbnail)) {
            ...
            $query = "INSERT INTO brand(status, name, description, thumbnail) VALUES('$status', '$name', '$description', '$thumbnail_path')";
        }
        ...
        if (mysqli_query($conn, $query)) {
            ...
            echo "<script>
                ...
                window.location.href = 'index.php?action=catalog&query=add-brand';
                </script>";
        } else {
            echo $query . 'error';
            $errormsg = "Error in adding brand...Please try again later!";
            echo "<script>
                alert('Error in adding brand...Please try again later!');
                window.location.href = 'index.php?action=catalog&query=add-brand
                </script>";
        }
    }
