...
INSERT INTO `comment` (`id`, `product_id`, `user_id`, `content`, `created_at`, `updated_at`, `status`) VALUES
(1, 27, 4, 'hello 1234', '2023-06-30 06:22:43', '0000-00-00 00:00:00', 0),
(2, 27, 4, 'Test bình luận', '2023-06-30 06:47:37', '0000-00-00 00:00:00', 0);
...
INSERT INTO `customer` (`id`, `username`, `password`, `email`, `fullname`, `phone`, `address`, `avatar`, `status`, `birthday`, `sex`, `date_update`, `point`) VALUES
(4, 'hungdoanhnguyen788649a88f47ce3b', '$2y$10$2BqTSt919dsqT1R4Iz7ZDe7Boj5HNAwpvrV5h5kU30PWllR2tEqUa', 'nguyenhungg127@gmail.com', 'Hung Doanh Nguyen', '+84337570675', '99 Tan Mai, Hoang Mai, Ha Noi', 'admin/uploads/avatars/customer/649a917d3e516_300-11.jpg', 1, '2023-06-01', 1, '2023-06-27 07:36:29', 0);
...
INSERT INTO `order` (`id`, `customer_id`, `payment_method_id`, `shipping_method_id`, `total`, `vat`, `subTotal`, `orderTotal`, `status`, `date_update`, `email`, `phone`, `address`, `date_ship`, `note`) VALUES
(1, 4, 19, 13, 3962, 198, 40, 4200, 0, '2023-06-27 07:21:46', 'nguyenhungg127@gmail.com', '+84337570675', '99 Tan Mai, Hoang Mai, Ha Noi', NULL, NULL),
(2, 4, 19, 13, 3962, 198, 40, 4200, 0, '2023-06-27 07:24:16', 'nguyenhungg127@gmail.com', '+84337570675', '99 Tan Mai, Hoang Mai, Ha Noi', NULL, NULL),
(3, 4, 19, 13, 5034, 252, 50, 5336, 0, '2023-06-28 03:34:30', 'nguyenhungg127@gmail.com', '+84337570675', '99 Tan Mai, Hoang Mai, Ha Noi', NULL, NULL);
...
INSERT INTO `payment_method` (`id`, `name`, `description`, `status`) VALUES
(19, 'COD', 'Collect on delivery', 1);
...
(7, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36 Edg/114.0.1823.58', 'Google Chrome', 'chrome', 'Windows 10', 'win-6', 'Computer', 'Unknown', 'XX', '/hurst/product.php?product=27', 'localhost', 'http://localhost/hurst/index.php', 0, '30 June 2023', '09:11', 0),
(8, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36 Edg/114.0.1823.58', 'Google Chrome', 'chrome', 'Windows 10', 'win-6', 'Computer', 'Unknown', 'XX', '/hurst/comment.php?product_id=27', 'localhost', 'http://localhost/hurst/product.php?product=27', 0, '30 June 2023', '09:11', 0),
(9, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36 Edg/114.0.1823.58', 'Google Chrome', 'chrome', 'Windows 10', 'win-6', 'Computer', 'Unknown', 'XX', '/hurst/login.php', 'localhost', 'http://localhost/hurst/comment.php?product_id=27', 0, '30 June 2023', '09:12', 0),
(10, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36 Edg/114.0.1823.58', 'Google Chrome', 'chrome', 'Windows 10', 'win-6', 'Computer', 'Unknown', 'XX', '/hurst/index.php', 'localhost', '', 0, '30 June 2023', '09:13', 0),
(11, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36 Edg/114.0.1823.58', 'Google Chrome', 'chrome', 'Windows 10', 'win-6', 'Computer', 'Unknown', 'XX', '/hurst/', 'localhost', '', 0, '30 June 2023', '17:21', 0),
(12, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36 Edg/114.0.1823.58', 'Google Chrome', 'chrome', 'Windows 10', 'win-6', 'Computer', 'Unknown', 'XX', '/hurst/admin/login.php', 'localhost', '', 0, '30 June 2023', '17:24', 0),
(13, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36 Edg/114.0.1823.58', 'Google Chrome', 'chrome', 'Windows 10', 'win-6', 'Computer', 'Unknown', 'XX', '/hurst/admin/login.php', 'localhost', '', 0, '30 June 2023', '17:25', 0);
...
(3, 'nguyenhungg127@gmail.com', '127.0.0.1', '30 June 2023', '17:24', 1);
...
INSERT INTO `shipping_method` (`id`, `name`, `description`, `status`, `price`) VALUES
(13, 'Expedited', 'Expedited is just a blanket term that means faster than the standard shipping time', 1, 2),
(14, 'Overnight', 'Similar to “expedited,” different carriers will often use different terminology branded and unique to their company.', 1, 3),
(15, 'Priority Mail', 'But don’t let the name fool you—it functions very similarly to shipping methods like expedited and overnight shipping.', 1, 3),
(16, 'Flat rate', '', 0, 4);
...
(1, 'DE127', '99 Tan Mai, Hoang Mai, Ha Noi', 'USD', '+84337570666', 'nguyenhungg127@gmail.com', 'fb.com/hungg.nd', 'uploads/shop/6488a815bcb70_Male faces-11.png', '99 Tan Mai, Hoang Mai, Ha Noi', 1);
