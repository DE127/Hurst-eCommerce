            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
                        ...
                        <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-50 mb-5 mb-xl-10"
                            ...
                            <div class="card-header pt-5">
                                ...
                                <div class="card-title d-flex flex-column">
                                    ...
                                    <!--end::Amount-->
                                    <!--begin::Subtitle-->
                                    <span class="text-white opacity-75 pt-1 fw-semibold fs-6">Products</span>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Title-->
                            </div>
                        ...
                        <!--end::Card widget 20-->
                        <!--begin::Card widget 7-->
                        <div class="card card-flush h-md-50 mb-5 mb-xl-10" style="background-image:url('assets/media/patterns/vector-1.png')">
                            <!--begin::Header-->
                            <div class="card-header pt-5">
                                <!--begin::Title-->
                                <div class="card-title d-flex flex-column">
                                    ...
                                    <!--end::Amount-->
                                    <!--begin::Subtitle-->
                                    <span class="text-gray-400 pt-1 fw-semibold fs-6">Customers</span>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Title-->
                            </div>
                    ...
                    <div class="col-xxl-6">
                        ...
                        <div class="card card-flush h-md-100" style="background-image:url('assets/media/stock/1600x800/main_morrow_2_4afb6d7f-84f5.png')">
                        </div>
