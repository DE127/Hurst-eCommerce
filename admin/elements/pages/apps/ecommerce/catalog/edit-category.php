<?php
$result = mysqli_query($conn, 'SELECT * FROM product_type WHERE id = ' . $_GET['id']);
									...
									<div class="card card-flush py-4">
										...
										<div class="card-body pt-0">
											...
											<div class="mb-10 fv-row">
												...
												<!--end::Label-->
												<!--begin::Input-->
												<input type="text" name="categoryname" class="form-control mb-2"
													placeholder="Category name" value="<?php echo $row['name'] ?>">
												<!--end::Input-->
												<!--begin::Description-->
											...
											<div>
												...
												<!--end::Label-->
												<textarea class="form-control" name="description" placeholder="Enter description category..." data-kt-autosize="true"><?php echo $row['description'] ?></textarea>
